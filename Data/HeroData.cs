...
public static class HeroData
{
  ...
  [
      new Hero(
          ...
          new Power(
              "Regeneración",
              "Recupera 20 puntos de salud inmediatamente.",
              2,
              (player, players) =>
              {
                  player.Health += 20;
      ...
      new Hero(
          ...
          new Power(
              "Ataque Titán",
              "Realiza un golpe con el triple de daño.",
              3,
              (player, players) =>
              {
                  for (int i = 0; i < 3; i++)
      ...
      new Hero(
          ...
          new Power(
              "Puñetazo serio",
              "Lanza un puñetazo que rompe todos los bloques, trampas, obstaculos que estén en el camino",
              5,
              (player, players) =>
              {
                player.AttackTarget();
